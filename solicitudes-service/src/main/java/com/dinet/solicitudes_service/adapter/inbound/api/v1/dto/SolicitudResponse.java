...
public class SolicitudResponse {
    ...
    @Schema(description = "Marca de una empresa o entidad", example = "Alicorp")
    private String marca;
    @Schema(description = "Tipo de solicitud", example = "Solicitud de servicio")
    private String tipoSolicitud;
    @Schema(description = "Fecha de envío de la solicitud", example = "2023-10-01")
    ...
    @Schema(description = "Contactos asociados a la solicitud")
